\section{複素測度}
	...
	\end{align}
	として置いてみるとよさそうである．$E$に対し$E$自体を一つの分割と見做せば，(\refeq{radon_nikodym_3})より$|\lambda|$は$\lambda$を支配していることになり，
	更に$|\lambda|$は$\mathcal{M}$上の測度となる(後述)から，(\refeq{radon_nikodym_2})と併せて当座の問題の解となる．
