\section{複素測度}
	...
	\end{align}
	が成り立つから(\refeq{eq:dfn_complex_measure})より
	\begin{align}
	...
	\end{align}
	が成立する．この場合(\refeq{radon_nikodym_1})を満たす最小の測度は
	\begin{align}
