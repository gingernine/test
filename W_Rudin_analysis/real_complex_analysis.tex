\documentclass[11pt,a4paper]{jsreport}%article}
%
...
\def\Re#1{\mathfrak{Re}\left[ #1 \right]} %実部
\def\Im#1{\mathfrak{Im}\left[ #1 \right]} %虚部
...
\newpage
\chapter{空間$\mathscr{L}^p$と空間$\mathrm{L}^p$}
	\input{../stochastic_differential_equation/report/report1}
\chapter{Lebesgue-Radon-Nikodymの定理}
	\input{chapters/complex_measures}
	\input{chapters/Radon_Nikodym}
\printindex
%
%
\end{document}