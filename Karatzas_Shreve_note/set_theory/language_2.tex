\chapter{$\varepsilon$項と内包項}
	...
	しかし，しかし乍ら，当然集合論と称している以上は「集合」というモノを扱っている筈なのに，
	...
	なぜか？というのも$\mathcal{L}_{\in}$の``名詞''は{\bf 変項}{\bf (variable)}だけなのだから...
...
\section{言語$\mathcal{L}_{\varepsilon}$}
	...
	\begin{screen}
		\begin{metathm}[$\mathcal{L}_{\varepsilon}$の始切片の一意性]\label{metathm:initial_segment_L_epsilon}
	...
	\begin{screen}
		\begin{metathm}[$\mathcal{L}_{\varepsilon}$のスコープの存在]
