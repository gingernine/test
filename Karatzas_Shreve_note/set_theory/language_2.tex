...
\section{式の書き換え}
	...
	たとえば，$x \in \varepsilon y B(y)$なる式を$\mathcal{L}_{\in}$の式に書き換えようと思ったら，
	$\varepsilon$項に込められた意味から
	\begin{align}
		\exists t\, (\, x \in t \wedge (\, \exists y B(y) \Longrightarrow B(t)\, )\, )
	\end{align}
	とするのが妥当であろうが，こうすると集合論では
	\begin{align}
		\forall x\, (\, x \in \varepsilon y\, (\, y=y\, )\, )
	\end{align}
	が成り立ってしまう．実際，任意の集合$x$に対して，$t$として$\{x\}$を取れば
	\begin{align}
		\exists t\, (\, x \in t \wedge (\, \exists y B(y) \Longrightarrow B(t)\, )\, )
	\end{align}
	が満たされるので
	...
	ところで本稿の体系では$\varepsilon y\, (\, y = y\, )$は集合となり，
	一方で全ての集合を要素に持つ集まりというのは集合ではないから，矛盾が起こる．
