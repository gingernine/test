\section{関係}
		...
		\begin{description}
			...
			\item[step6] この段では
				\begin{align}
					...
					\end{gathered}
				\end{align}
				を示す．(\refeq{fom:equality_of_ordered_pairs_8})と相等性公理より
				\begin{align}
				...
				\begin{align}
					...
					\end{gathered}
				\end{align}
				が従う．これと(\refeq{fom:equality_of_ordered_pairs_10})との三段論法より
				\begin{align}
					\begin{gathered}
			...
			\item[step8] 集合の対は集合(定理\ref{thm:pair_of_sets_is_a_set})なので
				...
				\end{align}
				が従う．他方で(\refeq{fom:equality_of_ordered_pairs_15})と選言三段論法
			...
			\item[step10] (\refeq{fom:equality_of_ordered_pairs_14})と(\refeq{fom:equality_of_ordered_pairs_18})と
				論理和の除去より
				\begin{align}
					\begin{gathered}
	...
	\begin{screen}
		\begin{dfn}[Cartesian積]
			...
			\end{align}
			により定めるクラス$a \times b$を$a$と$b$の{\bf Cartesian積}
	...
	\begin{screen}
		\begin{dfn}[関係]
			$R \subset \Univ \times \Univ$を満たすクラス$R$を{\bf 関係}\index{かんけい@関係}{\bf (relation)}と呼ぶ．
		\end{dfn}
	\end{screen}