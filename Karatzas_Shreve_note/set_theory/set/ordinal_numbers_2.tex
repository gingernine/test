	...
	\begin{prf}
		...
		\begin{description}
			\item[step1] まず
				...
				\end{align}
				が従う．(\refeq{fom:element_and_proper_subset_correspond_1})と
				(\refeq{fom:element_and_proper_subset_correspond_2})と論理積の導入より
				\begin{align}
					a \in b,\ \ord{b},\ \EXTAX,\EQAX,\COMAX,\PAIAX,\REGAX \vdash 
					a \subset b \wedge a \neq b
				\end{align}
				となるので，すなわち
				\begin{align}
