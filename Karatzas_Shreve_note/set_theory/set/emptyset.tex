\section{空集合}
	...
	\begin{sketch}
		...
		\end{align}
		とおけば，(\refeq{fom:thm_emptyset_is_a_set_2})と全称記号の推論規則より
		\begin{align}
			\EXTAX,\EQAX,\REPAX \vdash 
		...
		\end{align}
		とおけば，(\refeq{fom:thm_emptyset_is_a_set_6})と全称記号の推論規則より
		\begin{align}
		...
		\end{align}
		が従い，全称記号の推論規則より(\refeq{fom:thm_emptyset_is_a_set_5})が出る．
		ゆえに外延性公理より
		\begin{align}
	...
	\begin{prf}\mbox{}
		\begin{description}
			...
			\item[step2]
				...
				(\refeq{fom:uniqueness_of_emptyset_3})と全称記号の推論規則より
				\begin{align}
	...
	\begin{prf}	
		...
		\end{align}
		が従う．等号の可換律(定理\ref{thm:symmetry_of_equality})より
		\begin{align}
			\EXTAX,\EQAX \vdash c = \tau \rarrow \tau = c
		\end{align}
		が成り立つので，(\refeq{fom:subclass_contains_all_elements_1})との三段論法より
		\begin{align}
			a \subset b,\ c \in a,\ \EXTAX,\EQAX,\ELEAX \vdash \tau = c
		...
		\begin{align}
			a \subset b,\ c \in a,\ \EXTAX,\EQAX,\ELEAX \vdash c \in b
		\end{align}
		が従う．そして演繹法則より
		\begin{align}
			\EXTAX,\EQAX,\ELEAX \vdash 
