\section{空集合}
		...
		\begin{description}
			...
			\item[step3]
				...
				\begin{align}
					...
					(\, x \in \zeta \lrarrow x \in \alpha \wedge \varphi(x)\, )
				\end{align}
				とおけば，(\refeq{fom:thm_axiom_of_separation_4})と全称記号の推論公理より
				\begin{align}
					\EXTAX,\EQAX,\REPAX \vdash 
				...
				(\refeq{fom:thm_axiom_of_separation_7})および存在記号の推論公理より
	...
	\begin{sketch}
		...
		\end{align}
		とおけば，(\refeq{fom:thm_emptyset_is_a_set_2})と全称記号の推論公理より
		\begin{align}
			\EXTAX,\EQAX,\REPAX \vdash 
		...
		\end{align}
		とおけば，(\refeq{fom:thm_emptyset_is_a_set_6})と全称記号の推論公理より
		\begin{align}
		...
		\end{align}
		が従い，全称の導出(推論法則\ref{logicalthm:derivation_of_universal_by_epsilon})より(\refeq{fom:thm_emptyset_is_a_set_5})が出る．
		ゆえに外延性公理より
		\begin{align}
	...
	\begin{prf}\mbox{}
		\begin{description}
			...
			\item[step2]
				...
				(\refeq{fom:uniqueness_of_emptyset_3})と全称記号の推論公理より
				\begin{align}
	...
	\begin{prf}
		...
		\begin{align}
			\EXTAX,\COMAX \vdash \tau \in \emptyset \rarrow \tau \in a
		\end{align}
		が成り立ち(推論法則\ref{logicalthm:rule_of_inference_3})，全称の導出(推論法則\ref{logicalthm:derivation_of_universal_by_epsilon})より
		\begin{align}
