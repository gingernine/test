\section{順序数}
	...
	\begin{sketch}\mbox{}
		\begin{description}
			...
			\item[step3] いま
				...
				\end{align}
				を示す．
				(\refeq{fom:no_pair_of_sets_go_round_10})より
				\begin{align}
				...
				\begin{align}
					...
					\chi \in \eta  \rarrow \eta \neq \gamma
				\end{align}
				となり，%対偶律2 (論理的定理\ref{logicalthm:contraposition_2})と
				演繹定理の逆より
				\begin{align}
					\chi \in \eta,\ \EXTAX,\EQAX,\COMAX,\PAIAX,\REGAX \vdash 
					\eta \neq \gamma
			...
			\item[step4] (\refeq{fom:no_pair_of_sets_go_round_2})と
				...
				\end{align}
				が従う．他方で(\refeq{fom:no_pair_of_sets_go_round_8})を導いたのと同様にして
				\begin{align}
					\EXTAX,\EQAX,\COMAX,\PAIAX,\REGAX \vdash \eta \notin \gamma
				\end{align}
				が成り立ち，(\refeq{fom:no_pair_of_sets_go_round_9})と相等性公理より
				\begin{align}
					\chi \in \eta,\ \EXTAX,\EQAX,\COMAX,\PAIAX,\REGAX \vdash 
					\eta \notin \chi
				\end{align}
	...
	\begin{sketch}\mbox{}
		\begin{description}
			...
			\item[step2] (\refeq{fom:no_three_sets_go_round_4})
			...
			\item[step3]
				...
				\end{align}
				を示す．(\refeq{fom:no_three_sets_go_round_22})より
				\begin{align}
				...
				\end{align}
				が成り立つが，(\refeq{fom:no_three_sets_go_round_7})と
			...
			\item[step4] 定理\ref{thm:union_of_pair_is_union_of_their_elements}より
				...
				\end{align}
				となるが，他方で(\refeq{fom:no_three_sets_go_round_14})より
				\begin{align}
					\EXTAX,\EQAX,\COMAX,\PAIAX,\UNIAX,\REGAX \vdash 
			...
			\item[step5] (\refeq{fom:no_three_sets_go_round_13})と
		(\refeq{fom:no_three_sets_go_round_10})より
		\begin{align}
		...
		\begin{align}
			...
			\chi = \gamma \vee (\, \eta = \gamma \vee \zeta = \gamma\, )
		\end{align}
		が従い，(\refeq{fom:no_three_sets_go_round_19})と選言三段論法
		(論理的定理\ref{logicalthm:disjunctive_syllogism})より
		\begin{align}
			\chi \in \eta \wedge \eta \in \zeta,\ 
			\EXTAX,\EQAX,\COMAX,\PAIAX,\UNIAX,\REGAX \vdash \chi = \gamma
		\end{align}
		が成り立つ．これと(\refeq{fom:no_three_sets_go_round_21})より
		\begin{align}
			\chi \in \eta \wedge \eta \in \zeta,\ 
