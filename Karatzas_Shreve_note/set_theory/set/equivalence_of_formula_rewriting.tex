...
\label{sec:equivalence_of_formula_rewriting}
	...
	\begin{table}[H]
		...
		\begin{tabular}{c|c}
			...
			$a \in \Set{z}{\psi}$ & $\widetilde{\psi}(z/a)$ \\ \hline
	...
	$\lang{\varepsilon}$の式$\widehat{\varphi}$を得たのであった．
	なお表の$\widetilde{\psi}$とは必要に応じて$\psi$の変項の名前替えを行った式であるが，
	\ref{subsec:formula_rewriting}節で述べた他の細かい注意点も全て満たされているとする．
