...
\subsection{階数}
	...
	\begin{metaprf}
		$\varepsilon x A$に従属する$\varepsilon$項が無ければ，
		$\varepsilon x A^{t}$に従属する$\varepsilon$項も無い．
		なぜならば，$s$にも$t$にも$x$は自由に現れていないのであり，
		仮に$A$に現れる$\varepsilon$項の中に$s$があったとしても，
		それが$t$へ置き換わったところで$\varepsilon x A$には従属しないからである．
