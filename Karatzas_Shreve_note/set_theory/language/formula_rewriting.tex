...
\label{subsec:formula_rewriting}
	...
	書き換え時に課す変項の条件が多いため読むだけでも嫌気がさすかもしれない．
	これらは全て{\bf 自由に現れる変項を書き換え後も自由ならしめるため}のものであるが，
	...
	違う変項を選んでも式の意味は変わらない．上の表にある項が満たしている条件は次である：
	...
	\begin{itemize}
		...
		\item (1)で$v$は$\psi$に自由に現れる$z$以外のどの変項とも$a$とも違う．
		
		\item (2)で$u$は$\varphi$に自由に現れる$y$以外のどの変項とも$b$とも違う．
		
		\item (3)で$u$は$\varphi$に自由に現れる$y$以外のどの変項とも，
			$\psi$に自由に現れる$z$以外のどの変項とも違う．
		
		\item (5)で$s$は$\varphi$に自由に現れる$y$以外のどの変項とも$b,u$とも違う．
			$u$は$\varphi$に自由に現れる$y$以外のどの変項とも違う．
		
		\item (6)で$s$は，$\varphi$に自由に現れる$y$以外のどの変項とも，
			$\psi$に自由に現れる$z$以外のどの変項とも，$u$とも違う．
			$u$は$\varphi$に自由に現れる$y$以外のどの変項とも違う．
			
		\item (1)から(6)では，$u$は$\varphi$の中で$y$への代入について自由であり，
			$u,v,s$は$\psi$の中で$z$への代入について自由である．
			
		\item (4)の「変項の名前替え」について．
			$a$が$\psi$の中で$z$への代入について自由でない場合，
			つまり$z$が$\forall a \chi$或いは$\exists a \chi$なる形の
			$\varphi$の部分式の中に自由に現れている場合，
			その$\forall a \chi$或いは$\exists a \chi$を
			$\forall b \chi(a/b)$或いは$\exists b \chi(a/b)$で置き換える．たとえば
			\begin{align}
			...
			\begin{align}
				\exists b\, (\, a \in b\, )
			\end{align}
			とすればよい．ただし新しく選ぶ変項$b$としては，その$\chi$には自由に現れていないものを取る．
			これは$\forall a \chi$或いは$\exists a \chi$に自由に現れていた項を束縛しないためである．
	\end{itemize}
	...
	\begin{screen}
		\begin{metadfn}[式の書き換え]
			...
			上表に従って直した式のこととする．また既存の変項の自由な出現を束縛しないように
			変項の名前替えをしただけの式も書き換えと認める．
		\end{metadfn}
	\end{screen}
			...
			\item[step1] $\varphi$が原子式であるとする．
				\begin{description}
					...
					\item[case6] $\varphi$が
						...
						\begin{itemize}
							...
							\item $x$と$z$が違うとき，$\widetilde{\psi}(z/x)(x/\tau)$は
								...
								\end{align}
								となるが，$\psi(x/\tau)$と$\widehat{\psi}(x/\tau)$は
								変項の名前が違うだけであるから，
					...
					\item[case7] $\varphi$が
						...
						従って$\tilde{\psi}(z/a)(x/\tau)$は
						$\widetilde{\psi}(x/\tau)(z/a)$である．他方で
						$\varphi(x/\tau)$は
						\begin{align}
							a \in \Set{z}{\psi(x/\tau)}
						\end{align}
						となるが，$\psi(x/\tau)$と$\widehat{\psi}(x/\tau)$は変項の
						名前が違うだけであるから，$\widetilde{\psi}(x/\tau)(z/a)$は
						$\varphi(x/\tau)$の書き換えである．
