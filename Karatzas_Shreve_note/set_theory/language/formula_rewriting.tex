				...
				\begin{description}
					\item[case1] $\varphi$が
						...
						\begin{align}
							\negation \hat{\psi}
						\end{align}
						なる式で書けるが，$\hat{\psi}$は$\psi$の書き換えであり，
					...
					\item[case2] $\varphi$が
						...
						\begin{align}
							\vee \hat{\psi} \hat{\chi}
						\end{align}
						なる式で書けるが，$\hat{\psi},\hat{\chi}$はそれぞれ$\psi,\chi$の
