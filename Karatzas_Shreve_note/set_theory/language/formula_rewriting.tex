...
\label{subsec:formula_rewriting}
	...
	\begin{table}[H]
		...
		\begin{tabular}{c|c|c|c}
			...
			(4) & $a \in \Set{z}{\psi}$ & $\psi(z/a)$ & 必要なら束縛変項の名前替え \\ \hline
			...
			\item[step1] $\varphi$が原子式であるとする．
				\begin{description}
					...
					\item[case6] $\varphi$が
						...
						となる．
						\begin{itemize}
							\item $x$と$z$が同じならば$\psi$の束縛変項の名前替えは必要ない．
					...
					\item[case7] $\varphi$が
						...
						\begin{align}
							a \in \Set{z}{\psi(x/\tau)}
						\end{align}
						となるが，$\psi(x/\tau)$と$\widehat{\psi}(x/\tau)$は束縛変項の
