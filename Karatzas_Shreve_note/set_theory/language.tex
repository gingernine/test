\chapter{言語}
	...
	\begin{align}
		\bot,\ \rightharpoondown,\ \vee,\ \wedge,\ \rarrow,\ \forall,\ \exists,\ =
	\end{align}
	...
	\begin{itemize}
		...
		\item 論理記号とは式に作用するものとして$\rightharpoondown,\vee,\wedge,\rarrow$のみとする．
...
\section{始切片}
	...
	\begin{description}
		...
		\item[ケース2] 式$\psi$と$\xi$が得られて$\varphi$が
			...
			$\varphi$が$\wedge \psi \xi$や$\rarrow \psi \xi$である場合も同じである．
...
\section{スコープ}
	$\varphi$を式とし，$s$を「$\natural,\in,\bot,\rightharpoondown,\vee,\wedge,\rarrow,\exists,\forall$」
