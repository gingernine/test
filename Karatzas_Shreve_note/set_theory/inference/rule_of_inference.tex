\section{推論}
	...
	\begin{prf}
		...
		\end{align}
		も成り立つ．(\refeq{fom:logicalthm_commutative_law_of_conjunction_1})と三段論法より
		\begin{align}
			A \wedge B \vdash A \rarrow B \wedge A
		\end{align}
		となり，(\refeq{fom:logicalthm_commutative_law_of_conjunction_2})と三段論法より
		\begin{align}
	...
	\begin{screen}
		\begin{logicalthm}[爆発律(矛盾からはあらゆる式が導かれる)]
