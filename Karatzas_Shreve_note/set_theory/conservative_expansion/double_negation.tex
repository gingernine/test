...
\subsection{保存拡大の補題}
	...
	\begin{screen}
		\begin{thm}[存在記号と論理和の交換]
		\label{classic:order_exchange_of_conjunction_and_existence}
			$\varphi$と$\psi$を式とし，$x$を変項とし，$x$が$\psi$に自由に現れているとするとき，
			\begin{align}
				\provable{\mbox{{\bf HK}}} (\, \varphi \vee \exists x \psi\, ) \rarrow \exists x\, (\, \varphi \vee \psi\, ).
			\end{align}
		\end{thm}
	\end{screen}
	...
	\begin{sketch}
		{\bf HK}の公理(DI1)より
		\begin{align}
			\varphi \provable{\mbox{{\bf HK}}} \varphi \vee \psi
		\end{align}
		となり，{\bf HK}の公理(EI)より
		\begin{align}
			\varphi \provable{\mbox{{\bf HK}}} \exists x\, (\, \varphi \vee \psi\, )
		\end{align}
		となり，演繹定理より
		\begin{align}
			\provable{\mbox{{\bf HK}}} \varphi \rarrow \exists x\, (\, \varphi \vee \psi\, )
			\label{fom:no_description_4_1}
		\end{align}
		が得られる．同様に{\bf HK}の公理(DI2)より始めて
		\begin{align}
			\provable{\mbox{{\bf HK}}} \psi \rarrow \exists x\, (\, \varphi \vee \psi\, )
		\end{align}
		が得られるが，ここで汎化により
		\begin{align}
			\provable{\mbox{{\bf HK}}} \forall x\, (\, \psi \rarrow \exists x\, (\, \varphi \vee \psi\, )\, )
		\end{align}
		が成り立ち，{\bf HK}の公理(EE)より
		\begin{align}
			\provable{\mbox{{\bf HK}}} \exists x \psi \rarrow \exists x\, (\, \varphi \vee \psi\, )
			\label{fom:no_description_4_2}
		\end{align}
		が従う．(\refeq{fom:no_description_4_1})と(\refeq{fom:no_description_4_2})と
		{\bf HK}の公理(DE)より
		\begin{align}
			\provable{\mbox{{\bf HK}}} (\, \varphi \vee \exists x \psi\, ) \rarrow \exists x\, (\, \varphi \vee \psi\, ).
		\end{align}
	...
	\begin{sketch}
		...
		\end{align}
		となり，(\refeq{fom:lemma_for_Henkin_expansion_1})との三段論法より
		\begin{align}
			\provable{\mbox{{\bf HK}}} \exists y\, (\, \exists x \varphi \rarrow \varphi(x/y)\, )
		\end{align}
		が出る．
