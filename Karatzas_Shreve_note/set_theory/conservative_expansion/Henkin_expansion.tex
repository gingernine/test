\section{Henkin拡大}
	...
	\begin{screen}
		\begin{logicalaxm}[第\ref{chap:inference}章の公理(命題論理)]
	...
	\begin{screen}
		\begin{logicalaxm}[第\ref{chap:inference}章の公理(量化)]
	...
	\begin{screen}
		\begin{metathm}[第\ref{chap:inference}章の体系で証明可能なら{\bf HK$\varepsilon$}でも証明可能]
