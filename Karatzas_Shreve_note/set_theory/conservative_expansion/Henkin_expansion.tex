...
\label{sec:Henkin_expansion}
	...
	\begin{sketch}
		...
		\footnote{
			...
			$\varepsilon x_{1} F_{1},\cdots,\varepsilon x_{m-1} F_{m-1}$の中には
			現れないので$\varphi_{i_{1}},\cdots,\varphi_{i_{m-1}}$の中にも現れず，
			これらの式は置換による影響を受けない．$\mathscr{S}$の公理も$\lang{\in}$の文であるから
			置換による影響を受けない．
		}，
		\begin{align}
			\varphi_{i_{1}},\cdots,\varphi_{i_{m-1}},\mathscr{S} 
