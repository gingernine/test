\section{相等性}
	...
	\begin{screen}
		\begin{axm}[置換公理]
			\begin{align}
				...
				\Longrightarrow \forall a\, \exists z\, \forall y\,
				\left[\, y \in z \Longleftrightarrow \exists x\, (\, x \in a \wedge 
				\varphi(x,y)\, )\, \right].
			\end{align}
		\end{axm}
	\end{screen}
	...
	\begin{sketch}
		...
		\begin{align}
			\forall x\, \forall y\, \forall z\, 
			\left[\, \psi(x,y) \wedge \psi(x,z) \Longrightarrow y = z\, \right]
		\end{align}
		...
		であれば
		\begin{align}
			y \in a \wedge (\, y = y \wedge \psi(y,y)\, )
		\end{align}
		が成り立つので，すなわち
		\begin{align}
