\section{Stopping Times}
	...
	\begin{itembox}[l]{Lemma: 弱停止時刻の可測性}
		...
		$t \geq 0$に対し$T \wedge t$は$\mathscr{F}_{t+}/\borel{[0,\infty]}$-可測である．
	\end{itembox}
	...
	\begin{prf}\mbox{}
		\begin{description}
			\item[第一段]
				...
				$\mathscr{F}_{t+}/\borel{[0,\infty]}$-可測であるから、
			...
			\item[第二段]
				...
				\begin{align}
					...
					&= A \cap \{T \leq S\} \cap \{T \wedge S \leq t\}
						+ A \cap \{T > S\} \cap \{T \wedge S \leq t\} \\
					&= A \cap \{T \leq t\} \cap \{T \wedge t \leq S \wedge t\}
						+ A \cap \{S \leq t\} \cap \{T \wedge t > S \wedge t\} \\
					&\in \mathscr{F}_{t+},
					\quad (\forall t \geq 0)
				\end{align}
				...
				また
				\begin{align}
					\{S \leq T\} \cap \{T \wedge S \leq t\}
					= \{S \wedge t \leq T \wedge t\} \cap \{S \leq t\}
					\in \mathscr{F}_{t+},
					\quad (\forall t \geq 0)
				\end{align}
				により$\{S \leq T\},\ \{T \leq S\} \in \mathscr{F}_{T+} \cap \mathscr{F}_{S+}$となり
				$\{T < S\},\ \{T > S\},\ \{T = S\} \in \mathscr{F}_{T+} \cap \mathscr{F}_{S+}$が従う．
			
			\item[第三段]
				$T$が正値停止時刻で$\{T < \infty\}$上で$S < T$
				を満たしているとき．任意の$A \in \mathscr{F}_{S+}$に対し
				\begin{align}
					A \cap \{T \leq t\}
	...
	\begin{prf}
		...
		\begin{align}
			...
			\quad (\forall t > 0)
		\end{align}
		が成り立つから$A \in \mathscr{F}_{T+}$が従う．
		また$\{T < \infty\}$上で$T < T_n,\ (\forall n \geq 1)$であるとき，
		Problem 2.22より$\mathscr{F}_{T+} \subset \bigcap_{n=1}^\infty \mathscr{F}_{T_n}$
		が従い，また任意の$A \in \bigcap_{n=1}^\infty \mathscr{F}_{T_n}$に対して
		\begin{align}
			A \cap \{T \leq t\}
			= \bigcap_{m=1}^\infty \bigcup_{n=1}^\infty A \cap \left\{T_n < t+\frac{1}{m}\right\}
			\in \mathscr{F}_{t+}
		\end{align}
		が成り立ち後半の主張が得られる．
		\QED
	...
	\begin{itembox}[l]{Problem 2.24}
		...
		\begin{align}
			...
			\begin{cases}
				...
				\frac{k}{2^n}; & \mbox{on $\Set{\omega}{\frac{k-1}{2^n} \leq T(\omega) < \frac{k}{2^n}}$}
			\end{cases}
		\end{align}
