\section{Stopping Times}
	...
	\begin{prf}
		...
		\begin{align}
			\rho(x,\Gamma) \coloneqq \inf{}{\Set{|x - y|}{y \in \Gamma}},
		...
		$T_n \coloneqq H_{\Gamma_n}$により定める$T_n,\ n=1,2,\cdots$は弱停止時刻である．
		また$H \coloneqq H_\Gamma$とおく．このとき，次の(1)と(2)が成立する．
		\begin{description}
			\item[(1)] $\{H = 0\} = \{X_0 \in \Gamma\}$が成り立つ．実際，
				$X_0(\omega) \in \Gamma$なら$H(\omega) = 0$であり，一方で
				$X_0(\omega) \notin \Gamma$なら，$\Gamma$が閉集合であることと
				パスの連続性より或る$h > 0$が存在して，
				\begin{align}
					X_t(\omega) \notin \Gamma,
					\quad (0 \leq t \leq h)
				\end{align}
				が満たされ$H(\omega) \geq h > 0$が従う．
				
			\item[(2)]
				任意の$\omega \in \{H > 0\},\ t > 0$に対して
				\begin{align}
					H(\omega) \leq t 
					\quad \Leftrightarrow \quad 
				...
				$\beta \coloneqq H(\omega)$とおけば
				\begin{align}
					X_\beta(\omega) \in \Gamma
				\end{align}
				が満たされる．任意に$n \geq 1$を取れば$X_\beta(\omega) \in \Gamma_n$となるから，
				或る$\delta > 0$に対して
				\begin{align}
					B_\delta(X_\beta (\omega)) \subset \Gamma_n 
				\end{align}
				が成り立ち，パスの連続性より
				$X_{\beta - \epsilon}(\omega) \in B_\delta(X_\beta (\omega))$
				を満たす$0 < \epsilon < \beta$が存在するから
				\begin{align}
					T_n(\omega) \leq \beta - \epsilon < \beta \leq t
				\end{align}
				が従う．逆に，$H(\omega) > t$を満たす$\omega \in \{H > 0\}$について
				\begin{align}
					X_s(\omega) \notin \Gamma,
		...
		\end{description}
		(1)(2)の結果，及び$T_n,\ n=1,2,\cdots$が弱停止時刻であることにより
		\begin{align}
			\{H \leq t\}
			= \{H \leq t\} \cap \{H > 0\} + \{H = 0\}
			...
			\quad (\forall t \geq 0)
		\end{align}
		が従い，これにより$H$は$(\mathscr{F}_t)$-停止時刻である．
		\QED
	\end{prf}
