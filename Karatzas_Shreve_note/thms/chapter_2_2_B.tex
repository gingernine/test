	...
	\begin{prf}\mbox{}
		\begin{description}
			...
			\item[第五段]
				...
				(\refeq{eq:chapter_2_theorem_2_8_3})より$\left\{X_{s_n}(\omega)\right\}_{n\in\Natural}$はCauchy列をなす．
				従って$\lim_{n \in \Natural}X_{s_n}(\omega)$が存在するが，
				(\refeq{eq:chapter_2_theorem_2_8_3})より$\lim_{n \in \Natural}X_{s_n}(\omega)$
