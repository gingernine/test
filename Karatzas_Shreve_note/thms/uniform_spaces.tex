\section{一様空間}
	...
	\begin{screen}
		\begin{dfn}[近縁系]\label{dfn:uniform_structure}
			...
			$S$上の{\bf 近縁系}\index{きんえんけい@近縁系}{\bf (system of entourages)}と呼び，
			対$(S,\mathscr{V})$を{\bf 一様空間}\index{いちようくうかん@一様空間}
			{\bf (uniform space)}と呼ぶ．また$\mathscr{V}$の要素を$(S,\mathscr{V})$-{\bf 近縁}\index{きんえん@近縁}
			{\bf (entourage)}と呼ぶ．
			\begin{description}
	...
	\begin{screen}
		\begin{dfn}[基本近縁系]
			...
			\end{align}
			を満たすものを$\mathscr{V}$の{\bf 基本近縁系}\index{きほんきんえんけい@基本近縁系}
	...
	\begin{screen}
		\begin{dfn}[一様位相]
			...
			\end{align}
			で定める$S$上の位相を$(S,\mathscr{V})$-{\bf 一様位相}\index{いちよういそう@一様位相}{\bf (uniform topology)}と呼ぶ．
		\end{dfn}
	\end{screen}
	...
	\begin{screen}
		\begin{dfn}[両立]
			...
			$\mathscr{V}$と$\mathscr{O}$は{\bf 両立}\index{りょうりつ@両立}する{\bf (compatible)}という．
		\end{dfn}
	\end{screen}
	...
	\begin{screen}
		\begin{thm}[完全正則なら一様化可能]
			$S$を完全正則空間とし，$C(S,\R)$で$S$から$\R$への連続写像の全体を表す．
			$f \in C(S,\R)$と$r > 0$に対し
			\begin{align}
				V(f,r) \defeq \Set{(x,y) \in S \times S}{\left| f(x) - f(y) \right| < r}
			\end{align}
			と定義し，$V(f,U)$の全体を
			\begin{align}
				\mathscr{A} \defeq \Set{V(f,r)}{f \in C(S,\R),\ r > 0}
			\end{align}
			とおいて，$\mathscr{A}$の空でない有限部分集合の交叉の全体を
			\begin{align}
				\mathscr{B} \defeq \Set{\bigcap A}{A \subset \mathscr{A},\ 
			...
			\begin{align}
				\mathscr{V} \defeq
				\Set{V}{V \subset S \times S \wedge
				\exists B \in \mathscr{B}\, \left(\, B \subset V\, \right)}
			\end{align}
	...
	\begin{prf}
		定理\ref{thm:uniform_topology_generated_by_mappings_coincides_with_initial_topology}より$\mathscr{V}$による一様位相と$C(S)$-始位相は一致する．
		そして完全正則性より$C(S)$-始位相は$S$の元の位相に一致する．
		\QED
	\end{prf}
	...
	\begin{screen}
		...
		\label{thm:Cauchy_sequences_on_pseudometric_spaces}
			$(S,d)$を擬距離空間とし，近縁系$\mathscr{V}$を
			定理\ref{thm:uniform_structure_on_pseudometric_spaces}の要領で定めるとき，
			$S$の任意の点列$(x_n)_{n \in \Natural}$に対し，$(x_n)_{n \in \Natural}$がCauchy列であることと
			\begin{align}
				\forall \epsilon > 0,\ 
				\exists N \in \Natural,\quad
...
(\refeq{eq:thm_complete_iff_every_Cauchy_seq_converges_if_entourage_contains_some_countable_subset})
	...
	\begin{screen}
		\begin{dfn}[同程度連続]
			...
			\index{どうていどれんぞく@同程度連続}{\bf (equicontinuous)}であるということを
			\begin{align}
			...
			\index{いちようどうていどれんぞく@一様同程度連続}{\bf (uniformly equicontinuous)}であるという．
		\end{dfn}
	\end{screen}