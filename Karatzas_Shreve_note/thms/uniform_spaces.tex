\subsection{一様空間}
	...
	\begin{screen}
		...
		\label{thm:uniform_structure_is_a_semigroup}
			$\mathscr{V}$を集合$S$の近縁系とするとき次が成り立つ:
			\begin{align}
				U \circ V \in \mathscr{V},\quad
				(U \circ V) \circ W = U \circ (V \circ W),
				\quad (\forall U,V,W \in \mathscr{V}).
			\end{align}
		\end{thm}
	\end{screen}
	すなわち$\circ$は$\mathscr{V}$で一般結合法則を満たす．
