\subsection{一様空間}
	...
	\begin{screen}
		\begin{dfn}[近縁系]\label{dfn:uniform_structure}
			...
			$S$上の{\bf 近縁系}\index{きんえんけい@近縁系}{\bf (system of entourages)}
	...
	\begin{screen}
		...
		\label{thm:uniform_topology_generated_by_mappings_coincides_with_initial_topology}
			...
			\begin{align}
				V(f,U) \coloneqq \Set{(x,y) \in S \times S}{(f(x),f(y)) \in U}
			\end{align}
			と定義し，$V(f,U)$の全体を
			\begin{align}
				\mathscr{A} \coloneqq \Set{V(f,U)}{f \in \mathscr{F},\ U \in \mathscr{U}}
			\end{align}
			とおいて，$\mathscr{A}$の空でない有限部分集合の交叉の全体を
			\begin{align}
				\mathscr{B} \coloneqq \Set{\bigcap A}{A \subset \mathscr{A},\ 
	...
	\begin{sketch}\mbox{}
		\begin{description}
			\item[第一段] $\mathscr{W}$が近縁系となることを示す．
				...
				\begin{align}
					\tilde{W} \coloneqq \bigcap_{i=1}^n V(f_i,\tilde{U}_i)
				\end{align}
				とおけば，各$i$で
				\begin{align}
					(x,z),(z,y) \in \tilde{W} 
	...
	\begin{screen}
		\begin{thm}[完全正則なら一様化可能]
			...
			\begin{align}
				V(f,r) \coloneqq \Set{(x,y) \in S \times S}{\left| f(x) - f(y) \right| < r}
			\end{align}
			と定義し，$V(f,U)$の全体を
			\begin{align}
				\mathscr{A} \coloneqq \Set{V(f,r)}{f \in C(S,\R),\ r > 0}
			\end{align}
			とおいて，$\mathscr{A}$の空でない有限部分集合の交叉の全体を
			\begin{align}
				\mathscr{B} \coloneqq \Set{\bigcap A}{A \subset \mathscr{A},\ 
