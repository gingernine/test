\subsection{回転数}
	...
	\begin{screen}
		\begin{dfn}[回転数]
			$a$を複素数とし，$\gamma$を閉路とする．
			\begin{align}
				a \notin \ran{\gamma}
			\end{align}
			であるとき，
			\begin{align}
				\Ind{\gamma}{a} \defeq \frac{1}{2 \cdot \pi \cdot \isym} \cdot \int_{\gamma} \frac{1}{z - a}\ dz
			\end{align}
			で定める$\Ind{\gamma}{a}$を$\gamma$の$a$周りの{\bf 回転数}\index{かいてんすう@回転数}{\bf (winding number)}と呼ぶ．
		\end{dfn}
	\end{screen}