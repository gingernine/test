		...
		\begin{description}
			...
			\item[第二段]
				...
				\begin{align}
					r = \infty
				\end{align}
				であるときは空虚な真より(\refeq{fom:thm_radius_of_convergence_1})が成立する．
				\begin{align}
					0 \leq r < \infty
				\end{align}
				であるときは
				...
				\end{align}
				が成り立つから(\refeq{fom:thm_radius_of_convergence_1})が従う．ゆえに
				\begin{align}
					\inf{n \in \Natural}{\sup{\substack{k \in \Natural \\ n < k}}{\sqrt[k]{|c_{k} \cdot z^{k}|}}}
					= 0 < 1
				\end{align}
			...
			\item[第三段]
				...
				\begin{align}
					...
					= |z| \cdot r
				\end{align}
				が成り立つので(\refeq{fom:thm_radius_of_convergence_2})が従う．
				\begin{align}
					r = 0
				\end{align}
				の場合は空虚な真より(\refeq{fom:thm_radius_of_convergence_2})が満たされる．ゆえにいずれの場合もCauchyの冪根判定法より
				\begin{align}
