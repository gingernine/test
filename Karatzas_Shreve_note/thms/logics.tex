...
\subsection{言語}
	...
	\monologue{
		院生「記号$\coloneqq$は定義記号と呼ばれ，右辺の類を左辺と名付けるという意味で使われます．
	...
	\monologue{
		院生「定義記号$\coloneqq$と同様に，$\overset{\mathrm{def}}{\Longleftrightarrow}$とは
			右辺の式を左辺の式で置き換えて良いという意味で使われます．」
	}
	
	\begin{screen}
		\begin{thm}[類はその部分類の全ての要素を含む]
