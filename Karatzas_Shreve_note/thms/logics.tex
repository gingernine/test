...
\subsection{言語}
	...
	対象と文字を併せて{\bf 項}\index{こう@項}{\bf (term)}と呼び，
	...
	\begin{screen}
		\begin{dfn}[宇宙]
			\begin{align}
				\Univ = \Set{x}{x=x}
			\end{align}
			で定める$\Univ$を{\bf 宇宙}\index{うちゅう@宇宙}{\bf (Universe)}と呼ぶ．
		\end{dfn}
	\end{screen}
	
	\monologue{
		院生「宇宙という壮大な言葉が出てきてしまいましたが，
			集合論の世界は$\Univ$の範囲内で語り尽くせてしまうのですから，
			現代数学にとって$\Univ$は宇宙そのものなのですね．
			また定理\ref{thm:Universe_and_ordinal_numbers}で$\Univ$の実態が明らかになるでしょう．
			我々はこの定理で集合とはどういうものかという問いへの答えを得ることになります．
