...
\subsection{言語}
	...
	\begin{prf}
		$\mathcal{L}$の任意の対象$\tau$に対して，推論規則\ref{metathm:reflective_law_of_implication}より
		\begin{align}
			\tau \in a \Longleftrightarrow \tau \in a
		\end{align}
		が成り立つから，$\tau$の任意性と推論規則\ref{metathm:fundamental_law_of_universal_quantifier}より
		\begin{align}
			\forall t\ (\ t \in a  \Longleftrightarrow t \in b\ )
		\end{align}
