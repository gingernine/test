	...
	\begin{itembox}[l]{研究室にて}
		院生「私の指導教官に``新約聖書がはじめにギリシア語で書かれたとき，`ことば'にはlogosが充てられた．
			...
			現代まで受け入れられてきたという事実を鑑みれば，ことばから始めようというのは人が生来持っている直観に対して自然な起りなのでしょう．」
	...
	\begin{itembox}[l]{研究室にて}
		院生「類は$V$の要素であれば集合と呼ばれ，$V$の要素でなければ真類と呼ばれます．
			...
			ここで{\bf 推論規則}\index{すいろんきそく@推論規則}{\bf (rule of inference)}なるものを導入します．」
	\end{itembox}
	...
	\begin{screen}
		\begin{thm}[空集合はただ一つ]
			空集合の公理を満たす集合はただ一つである．つまり次が成立する:
			\begin{align}
	...
	\begin{itembox}[l]{研究室にて}
		院生「はじめのうちは空論が続いていたようですけれど，ようやく存在が約束された本物の集合が出てきましたね．
			空集合の公理を日本語に翻訳すれば``いかなる集合も要素に持たない集合が存在する''となります．
			この何も持たない空の集合を{\bf 空集合}\index{くうしゅうごう@空集合}{\bf (empty set)}と呼び$\emptyset$という記号で表します．
