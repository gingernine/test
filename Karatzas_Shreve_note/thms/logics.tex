	\monologue{
		院生「現代的な数学では，数や関数など数学に関するあらゆるものは集合で構成されます．
			...
			述語関数などといったものを取り扱っていたり，さらには集合が登場してきたりするものばかりで残念です．
			モノの数え方すら知らない生まれたばかりの世界に立って色々説明しようというのに，
			その準備の段階で数の存在を予定したり集合や関数の概念を前借りしたりして
			集合論と論理学が循環してしまうのは，勉強する側にとってはただの障壁にしかなりません．
			集合論と論理学は切り離せないのですから，いっそ同時並行でそつなく理解してやりましょう．」
	}
\subsection{言語}
	\begin{quote}
