	...
	\begin{prf}\mbox{}
		\begin{description}
			\item[第一段] $\inf{}{\Set{t \in [s,\infty)}{Z_t(\omega) = b}} = \inf{}{\Set{t \in [0,\infty)}{Z_{t+s}(\omega) = b}} + s$と
				...
				\end{align}
				となり，$T(\omega) \leq t < T(\omega)$が従い矛盾が生じる．よって(\refeq{eq:chapter_1_Problem_3_28_1})が出る．
				
				
			\item[第二段]
				(i)を示す．いま，任意に$A \in \mathscr{F}_s$と$t \geq s$を取れば，任意抽出定理と
				(\refeq{eq:chapter_1_Problem_3_28_1})より
				\begin{align}
					\int_{A \cap \{Z_s < b\}} Z_s\ dP
					&= \int_{A \cap \{Z_s < b\}} Z_{T \wedge t}\ dP \\
					&= \int_{A \cap \{Z_s < b\}} Z_T \defunc_{\{T \leq t\}}\ dP
						+ \int_{A \cap \{Z_s < b\}} Z_t \defunc_{\{T > t\}}\ dP \\
					&= b P\left[ A \cap \{Z_s < b\} \cap \{T \leq t\} \right]
						+ \int_{A \cap \{Z_s < b\}} Z_t \defunc_{\{T > t\}}\ dP
				\end{align}
				が成立し，$t \geq s$の任意性より
				\begin{align}
				...
				\end{align}
				が得られ，(\refeq{eq:chapter_1_Problem_3_28_2})より
				\begin{align}
					\int_{A \cap \{Z_s < b\}} Z_s\ dP
				...
				\end{align}
				となる．$A \in \mathscr{F}_s$は任意に取っていたから
				\begin{align}
