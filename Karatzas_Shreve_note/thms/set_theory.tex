	...
	\begin{prf}
		...
		\end{align}
		が共に成り立つので，推論法則\ref{metathm:rule_of_inference_3}より
		\begin{align}
		...
		\end{align}
		が成立し，$\tau$の任意性と推論法則\ref{metathm:fundamental_law_of_universal_quantifier}から
		\begin{align}
	...
	\begin{prf}
		...
		\end{align}
		が成り立つ．この対偶を取り推論法則\ref{metathm:properties_of_quantifiers}を適用すれば
		\begin{align}
