\section{距離空間}
	...
	\begin{screen}
		...
		\label{thm:base_on_pseudometric_space}
			...
			\begin{align}
				\mathscr{B} \coloneqq \Set{B_{1/n}(x)}{x \in S,\ n \in \Natural}
				\label{eq:thm_base_on_pseudometric_space_1}
			\end{align}
			は$S$の基底をなす．
			また$S$が可分であるとき，つまり$S$で稠密な高々可算集合$M$が存在するとき，
			\begin{align}
				\mathscr{B}_0 \coloneqq \Set{B_{1/n}(x)}{x \in M,\ n \in \Natural}
			\end{align}
