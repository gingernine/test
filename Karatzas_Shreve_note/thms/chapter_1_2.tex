\section{Stopping Times}
	\begin{itembox}[l]{$[0,\infty]$の位相}
		$[0,\infty]$の位相は$[-\infty,\infty]$の相対位相である．
		$\emptyset \neq O \subset [-\infty,\infty]$が開集合であるとは，
		任意の$x \in O$に対し，
		\begin{description}
		...
		\begin{align}
			...
			\quad (\forall a \in \Q \cap [0,\infty))
		\end{align}
	...
	\begin{itembox}[l]{Problem 2.17 修正}\label{chapter_1_Problem_2_17}
		\textcolor{red}{Let $T,S$ be stopping times and $Z$ an $\mathscr{F}/\borel{\R}$-measurable, 
		integrable random variable. Then
		\begin{align}
			A \in \mathscr{F}_T \quad \Longrightarrow \quad A \cap \{T \leq S\},
			A \cap \{T < S\} \in \mathscr{F}_{S \wedge T},
		\end{align}
		and we have
		\begin{description}
	...
	\begin{itembox}[l]{Proposition 2.18 修正}\label{chapter_1_Problem_2_18}
		...
		Then the random variable \textcolor{red}{$X_T \defunc_{\{T < \infty\}}$} is $\mathscr{F}_T$-measurable, and
