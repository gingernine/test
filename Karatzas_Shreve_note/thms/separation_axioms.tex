\section{分離公理}
	...
	\begin{sketch}
		...
		\begin{align}
			f_n \ast u = \{0\} \wedge f_n \ast (S \backslash a_n) = \{1\} \wedge \ran{f_n} \subset [0,1]
		\end{align}
		なる$\mathscr{O}/\mathscr{O}_\R$-連続写像$f_n$と
		\begin{align}
			g_n \ast v = \{0\} \wedge g_n \ast (S \backslash b_n) = \{1\} \wedge \ran{g_n} \subset [0,1]
		\end{align}
		なる$\mathscr{O}/\mathscr{O}_\R$-連続写像$g_n$が取れるから，
		\begin{align}
