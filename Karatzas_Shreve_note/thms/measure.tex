		...
		\begin{prf}\mbox{}
			\begin{description}
				\item[第一段]
					...
					$\bigotimes_{i=1}^n \mathcal{B}_i \subset \bigotimes_{i=1}^n \mathfrak{M}_i$
					が従う．このとき
					\begin{align}
						\left[ \bigotimes_{i=1}^n \mu_i \right](B) 
						= \left[ \bigotimes_{i=1}^n m_i \right](B),
						\quad (\forall B \in \bigotimes_{i=1}^n \mathcal{B}_i)
					...
					\end{align}
					を満たす増大列$\left( X^k_i \right)_{k=1}^\infty$が存在するから，ここで
					\begin{align}
						X^k \coloneqq X^k_1 \times \cdots \times X^k_n,
						\quad (k=1,2,\cdots)
					\end{align}
					により$\bigotimes_{i=1}^n \mathcal{B}_i$の増大列$(X^k)_{k=1}^\infty$を定めれば
					\begin{align}
						\prod_{i=1}^n X_i = \bigcup_{k=1}^\infty X^k,
						\quad \left[ \bigotimes_{i=1}^n \mu_i \right](X^k)
						= \mu_1(X^k_1) \cdots \mu_n(X^k_n) < \infty;
						\quad (k=1,2,\cdots)
					\end{align}
					が満たされる．ここで$\bigotimes_{i=1}^n \mathcal{B}_i$を生成する乗法族を
					\begin{align}
						\mathcal{A} \coloneqq
					...
					\begin{align}
						\left[ \bigotimes_{i=1}^n \mu_i \right](B_1 \times \cdots \times B_n)
						= \mu_1(B_1) \cdots \mu_n(B_n)
						= m_1(B_1) \cdots m_n(B_n)
						= \left[ \bigotimes_{i=1}^n m_i \right](B_1 \times \cdots \times B_n)
					\end{align}
				...
				\item[第二段]
					\begin{align}
						\bigotimes_{i=1}^n \mathfrak{M}_i
						\subset \overline{\bigotimes_{i=1}^n \mathcal{B}_i}
					...
					このとき，$\prod_{i=1}^n X_i$から$X_j$への射影を$p_j$と書けば
					\begin{align}
						p_j^{-1}\left(B^1_j\right) \subset p_j^{-1}(E_j) \subset p_j^{-1}\left(B^2_j\right),
						\quad p_j^{-1}\left(B^1_j\right),p_j^{-1}\left(B^2_j\right) \in \bigotimes_{i=1}^n \mathcal{B}_i
					\end{align}
					及び
					\begin{align}
						\left[ \bigotimes_{i=1}^n \mu_i \right] \left(p_j^{-1}\left(B^2_j\right)-p_j^{-1}\left(B^1_j\right)\right)
						= \mu_1(X_1) \cdots \mu_j\left(B^2_j - B^1_j\right) \cdots \mu_n(X_n)
						= 0
					\end{align}
					が成り立つから
					\begin{align}
						p_j^{-1}(E_j) \in \overline{\bigotimes_{i=1}^n \mathcal{B}_i}
					\end{align}
					が従い，
					\begin{align}
				...
				\item[第三段]
					任意の$E \in \bigotimes_{i=1}^n \mathfrak{M}_i$に対し
					\begin{align}
						\left[ \bigotimes_{i=1}^n m_i \right](E)
						= \overline{\left[ \bigotimes_{i=1}^n \mu_i \right]}(E)
					\end{align}
					が成り立つことを示す．実際，(\refeq{eq:thm_product_space_of_complete_measure_space_2})より
					$E \in \bigotimes_{i=1}^n \mathfrak{M}_i$なら$E \in \overline{\bigotimes_{i=1}^n \mathcal{B}_i}$
					となるから，
					\begin{align}
						B_1 \subset E \subset B_2,
						\quad \left[ \bigotimes_{i=1}^n \mu_i \right](B_2-B_1) = 0,
						\quad \overline{\left[ \bigotimes_{i=1}^n \mu_i \right]}(E)
						= \left[ \bigotimes_{i=1}^n \mu_i \right](B_1)
						\label{eq:thm_product_space_of_complete_measure_space_3}
					\end{align}
					を満たす$B_1,B_2 \in \bigotimes_{i=1}^n \mathcal{B}_i$が存在し，このとき
					(\refeq{eq:thm_product_space_of_complete_measure_space_1})より
					\begin{align}
						\left[ \bigotimes_{i=1}^n m_i \right](E-B_1)
						\leq \left[ \bigotimes_{i=1}^n m_i \right](B_2-B_1)
						= \left[ \bigotimes_{i=1}^n \mu_i \right](B_2-B_1)
						= 0
					\end{align}
					が成立し
					\begin{align}
						\left[ \bigotimes_{i=1}^n m_i \right](E)
						= \left[ \bigotimes_{i=1}^n m_i \right](B_1)
						= \left[ \bigotimes_{i=1}^n \mu_i \right](B_1)
						= \overline{\left[ \bigotimes_{i=1}^n \mu_i \right]}(E)
					\end{align}
					が得られる．
				...
				\item[第四段]
					前段の結果より
					$\left( \prod_{i=1}^n X_i, \overline{\bigotimes_{i=1}^n \mathcal{B}_i}, \overline{\bigotimes_{i=1}^n \mu_i} \right)$
					は$\left( \prod_{i=1}^n X_i, \bigotimes_{i=1}^n \mathfrak{M}_i, \bigotimes_{i=1}^n m_i \right)$
					の完備拡張であるから，
					\begin{align}
						\overline{\bigotimes_{i=1}^n \mathfrak{M}_i}
						\supset \overline{\bigotimes_{i=1}^n \mathcal{B}_i}
					\end{align}
					を示せば定理の主張を得る．実際，
					任意の$E \in \overline{\bigotimes_{i=1}^n \mathcal{B}_i}$に対し
					(\refeq{eq:thm_product_space_of_complete_measure_space_3})を満たす
					$B_1,B_2 \in \bigotimes_{i=1}^n \mathcal{B}_i$を取れば，
					\begin{align}
						\left[ \bigotimes_{i=1}^n m_i \right](B_2-B_1)
						= \left[ \bigotimes_{i=1}^n \mu_i \right](B_2-B_1)
						= 0
					\end{align}
					が成り立ち$E \in \overline{\bigotimes_{i=1}^n \mathfrak{M}_i}$が従う．
					\QED
			\end{description}
		\end{prf}