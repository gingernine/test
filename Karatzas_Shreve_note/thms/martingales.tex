\section{確率過程}
	...
	\begin{screen}
		\begin{dfn}[確率過程]
			...
			\end{itemize}
			を満たすとき，$X$を$\mathbf{T} \times \Omega$上の$S$値$\mathscr{F}$-{\bf 過程}{\bf (stochastic process)}と呼ぶ．
		\end{dfn}
	\end{screen}
	...
	\begin{itemize}
		\item $X$が$\borel{\mathbf{T}} \otimes \mathscr{F}/\borel{S}$-可測であるとき，
			...
			{\bf (measurable stochastic process)}と呼ぶ．
		\item $\mathbf{T}$の任意の$t$要素に対して，$X$の$[0,t] \times \Omega$への制限写像
			...
			{\bf (progressively measurable stochastic process)}と呼ぶ．
	\end{itemize}
