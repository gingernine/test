		...
		\begin{description}
			...
			\item[第四段]
				...
				\begin{align}
					y \in u[x]
				\end{align}
				が従う．以上で(\refeq{fom:thm_quotient_topological_vector_space_2})が得られた．
				次に正の実数$t$が与えられたときに
				\begin{align}
				...
				\end{align}
				が従う．以上で(\refeq{fom:thm_quotient_topological_vector_space_3})も得られた．
				...
				\end{align}
				が成り立つので(\refeq{fom:thm_quotient_topological_vector_space_4})も得られた．
			...
			\item[第五段]
				...
				(\refeq{fom:thm_quotient_topological_vector_space_2})より
				\begin{align}
