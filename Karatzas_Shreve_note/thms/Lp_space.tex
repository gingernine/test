...
\begin{prf}
	...
	同様に$N_2 > N_1$を満たす$N_2 \in \Natural$が存在して
	\begin{align}
	...
	\begin{description}
		\item[$p = \infty$の場合]
			...
			\end{align}
			が成り立つ．
			このとき任意の$\epsilon > 0$に対し$1/2^N < \epsilon$を満たす$N \in \Natural$を取れば，$\ell > k > N$なら
			\begin{align}
			...
			\begin{align}
				...
				\quad (\forall x \in X)
			\end{align}
			として$\hat{f}$を定めれば，$\hat{f}$は可測$\mathscr{F}/\borel{\C}$であり，且つ任意に$k \in \Natural$を取れば
			\begin{align}
