		...
		\begin{description}
			\item[第一段]
				...
				\begin{align}
					...
					\right]
				\end{align}
				が得られ，(\refeq{fom:compactness_and_finite_intersection_property_1})を得る．
				
			\item[第二段]
				(\refeq{fom:compactness_and_finite_intersection_property_1})が成り立っているとし，
				...
				\begin{align}
					\mathscr{U} \subset \mathscr{A}
				\end{align}
				が成り立つので，(\refeq{fom:compactness_and_finite_intersection_property_1})より
				\begin{align}
					\mathscr{V} \subset \Set{b \cap w}{w \in \mathscr{U}}
