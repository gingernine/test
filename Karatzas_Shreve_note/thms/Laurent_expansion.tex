\subsection{Laurent展開}
	いま$R$を正の実数とし，$f$を$\disc{0}{R} \backslash \{0\}$上の正則関数とする．
	また$z$を$\disc{0}{R} \backslash \{0\}$の要素とし，$r$と$\rho$を
	\begin{align}
		r < |z| < \rho < R
	\end{align}
	を満たす正の実数とする．
	...
	\begin{center}
		\begin{tikzpicture}
			...
			%rho=2.5, r=1
			\draw [domain=0:1, thick, samples=200, color=blue] plot({2.5*cos(2*pi*\x r)},{2.5*sin(2*pi*\x r)});
			\draw [domain=0:1, thick, samples=200, color=blue] plot({cos(2*pi*\x r)},{sin(2*pi*\x r)});
			
			\draw [<-] (0,0) -- ({0.3*cos(25*pi/12 r)},{0.3*sin(25*pi/12 r)});
			\node at ({0.5*cos(25*pi/12 r)},{0.5*sin(25*pi/12 r)}) {$r$};
			\draw [->] ({0.7*cos(25*pi/12 r)},{0.7*sin(25*pi/12 r)}) -- ({cos(25*pi/12 r)},{sin(25*pi/12 r)});
			
			\draw [<-] (0,0) -- ({1.2*cos(17*pi/12 r)},{1.2*sin(17*pi/12 r)});
			\node at ({1.4*cos(17*pi/12 r)},{1.4*sin(17*pi/12 r)}) {$\rho$};
			\draw [->] ({1.6*cos(17*pi/12 r)},{1.6*sin(17*pi/12 r)}) -- ({2.5*cos(17*pi/12 r)},{2.5*sin(17*pi/12 r)});
			
			\draw [<-] (0,0) -- ({1.3*cos(3*pi/4 r)},{1.3*sin(3*pi/4 r)});
			\node at ({1.5*cos(3*pi/4 r)},{1.5*sin(3*pi/4 r)}) {$R$};
			\draw [->] ({1.7*cos(3*pi/4 r)},{1.7*sin(3*pi/4 r)}) -- ({3*cos(3*pi/4 r)},{3*sin(3*pi/4 r)});
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw [domain=0:5/8-1/240, thick, samples=200, color=blue] plot({2.5*cos(2*pi*\x r)},{2.5*sin(2*pi*\x r)});
			\draw [thick, color=blue] ({2.5*cos(2*pi*(5/8-1/240) r)},{2.5*sin(2*pi*(5/8-1/240) r)}) -- ({cos(2*pi*(18/8-(13/8+1/100)) r)},{sin(2*pi*(18/8-(13/8+1/100)) r)});
			...
			\draw [thick, color=blue] ({cos(2*pi*(26/8-(21/8-1/100)) r)},{sin(2*pi*(26/8-(21/8-1/100)) r)}) -- ({2.5*cos(2*pi*((29/8+1/240)-3) r)},{2.5*sin(2*pi*((29/8+1/240)-3) r)});
			\draw [domain=29/8+1/240:4-1/200, thick, samples=200, color=blue, ->] plot({2.5*cos(2*pi*(\x-3) r)},{2.5*sin(2*pi*(\x-3) r)});
			%角度
	...
	\begin{description}
		...
		\item[(\refeq{fom:Laurent_series_7})の略証]	
			...
			(\refeq{fom:Laurent_series_8})と(\refeq{fom:Laurent_series_10})も同様にして得られる．
	...
	{\bf ここで重要なのは，積分表示してしまえば級数展開できるということである．}いまの場合は
	\begin{align}
	...
	\begin{screen}
		\begin{thm}[Laurent展開]
			...
			\end{align}
			が成立する．この級数展開を$f$の$a$における{\bf Laurent展開}\index{Laurent展開}{\bf (Laurent expansion)}と呼ぶ．
		\end{thm}
	\end{screen}
	...
	\begin{screen}
		\begin{dfn}[主部]
			...
			\end{align}
			で定める$\C \backslash \{a\}$上の写像を$f$の$a$における{\bf 主部}\index{しゅぶ@主部}{\bf (principal part)}と呼ぶ．
		\end{dfn}
	\end{screen}