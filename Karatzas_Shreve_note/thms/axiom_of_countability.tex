\subsection{可算公理}
	...
	後述の一様位相空間(距離空間や第一可算な位相線型空間に共通する構造が定義された空間)は
	$\sigma$-局所有限な基底を持つ(定理\ref{thm:if_uniformity_has_countable_base_then_has_topology_has_sigma_locally_finite_base})．従って以下のいくつかの定理の結果はそのまま
