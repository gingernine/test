	...
	\begin{sketch}\mbox{}
		\begin{description}
			...
			\item[step2]
				...
				\begin{align}
					A \defeq \left\{\, x \mid \quad 
					\exists t \in [0,1]\, \exists \omega \in \Omega\, \exists a\,  \right.
					&\left[\, x = ((t,\omega),a) \right. \wedge \\
					&\quad (\, \omega \notin F \Longrightarrow \forall n \in \Natural
					(\, t \leq \tau_{n}(\omega) \Longrightarrow a = A^{(n)}(t,\omega)\, ) \\
					&\quad \left.\left. \wedge \omega \in F \Longrightarrow a = 0\, )\, \right]\, \right\}
				\end{align}
