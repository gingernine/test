\subsection{Doob分解}
	...
	ところで，いま$(S,d)$を距離空間として，$a$を$S$の要素とし，$h$を$a$へ収束する$S$上の点列とする．
	...
	\begin{align}
		...
		&\wedge \dom{x} = 0 \Longrightarrow d(h(y),a) < \frac{1}{4} \wedge \forall z \in \Natural\, \left(\, d(h(z),a) < \frac{1}{4}
		\Longrightarrow y \leq z\, \right) \\
