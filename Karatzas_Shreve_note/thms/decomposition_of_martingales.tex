	...
	\begin{sketch}\mbox{}
		\begin{description}
			...
			\item[step1-3]
				...
				\begin{align}
					E_k \defeq \left\{ \frac{1}{2^k} 
					\leq \sup{t \in [0,1]}{\left|\left(X^2_t - h(n_k)_t\right) - A_t\right|} \right\}
				\end{align}
				とおけば
				\begin{align}
					P(E_k) < \frac{1}{2^k}
			...
			\item[step2-1]
				...
				すなわち定理\ref{thm:direct_product_of_non_empty_sets_is_not_empty}より，
				任意の自然数$n$に対して，
				\begin{align}
