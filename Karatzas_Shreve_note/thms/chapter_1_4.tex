		...
		\begin{description}
			...
			\item[第二段]
				...
				\begin{align}
					...
					\quad (t \geq 0)
				\end{align}
				とおけば，$\eta^{(n)}$の右連続性，Corollary 2.4， Problem2.5 及びusual条件より
				\begin{align}
			...
			\item[第三段]
				...
				\end{align}
				より$T^{(n)}_\epsilon \defunc_{\Omega \backslash F}$も停止時刻であり，
				単調性より
				\begin{align}
			...
			\item[第四段]
				...
				が満たされるから
				\begin{align}
					\lim_{k \to \infty} \xi^{(n_k)}_t = \lambda \wedge A_t,
					\quad (\forall t \in [0,a])
				\end{align}
				となり
				\begin{align}
				...
				\end{align}
				となり，$A$の単調非減少性より$A_{t-} \leq A_t$となるから
				\begin{align}
					\int_{(0,a]} (\lambda \wedge A_t) - (\lambda \wedge A_{t-})\ dA_t = 0,
					\quad \mbox{a.s. $P$}
				\end{align}
				が成立し
				\begin{align}
					(0,a] \ni t \longmapsto \lambda \wedge A_t 
				\end{align}
				は連続となる．$a > 0$の任意性より
				\begin{align}
					(0,\infty) \ni t \longmapsto \lambda \wedge A_t 
				...
				は連続となる．
				\begin{align}
					\tilde{A}_t \coloneqq A \defunc_{\Omega \backslash }
				\end{align}
				と置けば$\tilde{A} \in [A]_{Nat}$を満たす．
				\QED
		\end{description}
	\end{prf}