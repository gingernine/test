...
%本文
\chapter{}
\input{thms/chapter_1_problems}
\input{thms/chapter_1_problems_2}
\input{thms/chapter_1_problems_3}
\input{thms/chapter_1_problems_4}
\chapter{}
\input{thms/dynkin_system}
\input{thms/consistency_theorem_Bogachev}
\input{thms/Kolmogorov_Centsov_theorem}
\input{thms/chapter_2_problems_3}
\input{thms/chapter_2_problems_4}
