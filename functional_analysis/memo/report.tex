...
\newpage
	...
	\begin{prf} $\ell^2$のノルムと内積をそれぞれ$\Norm{\cdot}{\ell^2},\inprod<\cdot,\cdot>$，
			...
			\item[(2)]
				...
				\begin{description}
					\item[必要性]
						...
						完全正規直交系$(\varphi^j)_{j=1}^{\infty}$に対して，(\refeq{eq:report_7_1})で定める$\Norm{T}{}$は
						\begin{align}
							\Norm{T}{}
					...
					\item[十分性]
						(\refeq{eq:report_7_1})の$\Norm{T}{}$が完全正規直交系の取り方に依らないことを示す．これを示せば
						(\refeq{eq:report_7_2})より$\Norm{T}{} = \Norm{a}{\ell^2} < \infty$が従い十分性が得られる．
