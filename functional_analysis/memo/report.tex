...
\newpage
	...
	\begin{prf} $\ell^2$におけるノルムを$\Norm{\cdot}{\ell^2}$と表す．
		\begin{description}
			...
			\item[(2)]
				...
				\begin{description}
					\item[必要性]
						...
						このとき(\refeq{eq:report_7_1})の$\Norm{T}{}$について
						\begin{align}
							\Norm{T}{}
					...
					\item[十分性]
						(\refeq{eq:report_7_1})で定義される$\Norm{T}{}$が完全正規直交系の取り方に依らずに確定することを示す．これが示されれば，
