...
\title{解析学5・関数解析学特論・関数解析II\ レポート}
\author{基礎工学研究科システム創成専攻修士1年\\学籍番号29C17095\\百合川尚学\\選択番号[4][5][6][7][8][9]}
\date{\today}
...
\begin{thebibliography}{9}
	\bibitem{key1} 伊藤・黒田・藤田, 関数解析, 岩波基礎数学選書, 2009, ISBN:978-4000078108.
\end{thebibliography}
\newpage
\printindex
