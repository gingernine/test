...
\section{推論}
	...
	\begin{screen}
		...
		\ref{logicalthm:weak_De_Morgan_law_for_quantifiers_1}
			$A$を$\mathcal{L}$の式とし，$x$を$A$に自由に現れる変項とし，
	...
	\begin{screen}
		...
		\ref{logicalthm:weak_De_Morgan_law_for_quantifiers_2}
			$A$を$\mathcal{L}$の式とし，$x$を$A$に自由に現れる変項とし，
			また$A$に自由に現れる変項は$x$のみであるとする．このとき
			\begin{align}
	...
	\begin{screen}
		...
		\ref{logicalthm:strong_De_Morgan_law_for_quantifiers_1}
			$A$を$\mathcal{L}$の式とし，$x$を$A$に自由に現れる変項とし，
			また$A$に自由に現れる変項は$x$のみであるとする．このとき
			\begin{align}
	...
	\begin{screen}
		...
		\ref{logicalthm:strong_De_Morgan_law_for_quantifiers_2}
			$A$を$\mathcal{L}$の式とし，$x$を$A$に自由に現れる変項とし，
			また$A$に自由に現れる変項は$x$のみであるとする．このとき
			\begin{align}
...
\section{対}
	...
	\begin{screen}
		\begin{thm}[集合は対の要素となれる]\ref{thm:set_is_an_element_of_its_pair}
			$a$と$b$を類とするとき
			\begin{align}
	...
	\begin{screen}
		...
		\ref{thm:classes_displayed_in_empty_pair_are_not_sets}
			$a$と$b$を類とするとき，
			\begin{align}
