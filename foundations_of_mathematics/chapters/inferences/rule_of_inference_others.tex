		...
		\begin{description}
			...
			\item[(b)]
				...
				\begin{align}
					...
					&\lrarrow\ \negation \exists x \negation \left( A(x) \wedge B(x) \right) & (\mbox{推論法則\ref{logicalthm:strong_De_Morgan_law_for_quantifiers_1}}) \\
					...
					&\lrarrow\ \negation \left( \negation \forall x A(x) \vee \negation \forall x B(x) \right) & (\mbox{推論法則\ref{logicalthm:weak_De_Morgan_law_for_quantifiers_1}}) \\
