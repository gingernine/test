...
\input{../Karatzas_Shreve_note/set_theory/incoherence}

\chapter{言語}
	\input{../Karatzas_Shreve_note/set_theory/language}
	\input{../Karatzas_Shreve_note/set_theory/language_2}
	\input{../Karatzas_Shreve_note/set_theory/language_3}

\chapter{推論}
	\input{../Karatzas_Shreve_note/set_theory/proof}
	%\input{../Karatzas_Shreve_note/set_theory/formula_rewriting_rejected}
	\input{../Karatzas_Shreve_note/set_theory/rule_of_inference}

\chapter{集合}	
	\input{../Karatzas_Shreve_note/set_theory/equality}

\chapter{イプシロン定理}
	\input{../Karatzas_Shreve_note/set_theory/epsilon_theorem_lang}
	\input{../Karatzas_Shreve_note/set_theory/epsilon_theorem_1}
	\input{../Karatzas_Shreve_note/set_theory/epsilon_theorem_2}

\chapter{メモ}
	\input{../Karatzas_Shreve_note/set_theory/quantification}
	\input{../Karatzas_Shreve_note/set_theory/replacement_scheme}

\chapter{Hilbert流証明論}
	\input{../Karatzas_Shreve_note/set_theory/Bekki_logic_note}
