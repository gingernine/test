...
\section{12}
	...
	\begin{description}
		...
		\item[(3)] $\varphi$が$p\tau_{1}\cdots\tau_{n}$なる式のとき，
			\begin{align}
				\Sigma \vdash_{\mathcal{L}} p\tau_{1}\cdots\tau_{n}
				&\Longleftrightarrow ([\tau_{1}],\cdots,[\tau_{n}]) \in p_{\mathfrak{A}} \\
				&\Longleftrightarrow \left(\val_{\mathfrak{A}}(\tau_{1}),\cdots,
				\val_{\mathfrak{A}}(\tau_{n})\right) \in p_{\mathfrak{A}} \\
				&\Longleftrightarrow \val_{\mathfrak{A}}(p\tau_{1}\cdots\tau_{n}) = T \\
				&\Longleftrightarrow \mathfrak{A} \models p\tau_{1} \cdots \tau_{n}
			\end{align}
			が成り立つ．
			
		\item[(4)] $\Sigma \vdash_{\mathcal{L}} \forall x \psi(x)$なら
			すべての閉項$\tau$で
			\begin{align}
				\Sigma \vdash_{\mathcal{L}} \psi(\tau)
			\end{align}
			となる．ゆえに(3)よりすべての閉項$\tau$で
			\begin{align}
				\mathfrak{A} \models \psi(\tau)
			\end{align}
			が成り立ち，(2)より
			\begin{align}
				\mathfrak{A} \models \forall x \psi(x)
			\end{align}
			が成り立つ．
			\QED
	\end{description}
