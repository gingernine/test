...
\newcommand{\dom}[1]{\operatorname*{dom}\hspace{0.15em}(#1)} %クラスの定義域
\newcommand{\ran}[1]{\operatorname*{ran}\hspace{0.15em}(#1)} %クラスの値域
...
\newcommand{\tran}[1]{\operatorname*{tran}\hspace{0.15em}(#1)} %推移的クラスの定義式
...
\maketitle
	...
	\begin{thebibliography}{数字}
		...
		\bibitem{TakeuchiSet} 竹内外史, 現代集合論入門, 増強版, 日本評論社, 2016, p. 159, ISBN 978-4-535-60116-1.
	\end{thebibliography}
\end{document}