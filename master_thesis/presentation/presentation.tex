...
%
%
\title{ $\varepsilon$計算とクラスの導入による \\ 具体的で直感的な集合論の構築}
\author{関根深澤研修士二年\\学籍番号：29C17095\\百合川尚学}
...
\input{slides/exists_rule}
\input{slides/formula_rewriting}
\input{slides/exists_rule_2}
\input{slides/forall_rule}
