\section{条件付き期待値の拡張}
	$\mu$の有限性とH\Ddot{o}lderの不等式より$\Lp{2}{\Omega,\mathcal{F},\mu} \subset \Lp{1}{\Omega,\mathcal{F},\mu}$且つ
	...
	\begin{prf}
		(\refeq{eq:composition_L2_conditional_expectation})において$P_{\mathcal{G}}$の作用素ノルムは1以下，
	...
	\begin{prf}\mbox{}
		\begin{description}
			...
			\item[$\tilde{\mathrm{C}}$5]
				...
				\begin{align}
					\varphi(t) = \sup{x \in \Q}{\left\{ a_x t + b_x \right\}} \quad (\forall t \in \R)
				...
				\end{align}
				が従い，(\refeq{eq:prp_properties_of_expanded_conditional_expectation_1})より
				\begin{align}
