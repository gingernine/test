	...
	\begin{prf}
		...
		\begin{description}
			\item[第一段]
				...
				\end{align}
				を満たす．(\refeq{eq:lem_quadratic_variation_0})より$N_0^n(\omega) = M^2_0(\omega)\ (\forall \omega \in \Omega,\ n=1,2,\cdots)$となるから
				\begin{align}
				...
				よってBorel-Cantelliの補題より部分列$(n_k)_{k=1}^{\infty}$と$\mu$-零集合$E$を取れば
				\begin{align}
				...
				\end{align}
				が従い，まず$A_0(\omega) = 0 \ (\forall \omega \in \Omega \backslash E)$が成り立つ．
				\begin{align}
