\section{10/11}
	基礎の確率空間を$(\Omega,\mathcal{F},\mu)$とする．係数体を$\R$として考えると，
	...
	\end{align}
	が成り立つからである．また内積の公理を満たすことも次のように示される．
	\begin{description}
		\item[正値性] 
		...
		\item[双線型性] 
			...
			\begin{align}
				...
				&= \int_{\Omega} f(x)g(x)\ \mu(dx) + \int_{\Omega} f(x)h(x)\ \mu(dx) \\
	...
	\end{align}
	によって$\Lp{2}{\Omega, \mathcal{G},\mu}$は$\Lp{2}{\Omega, \mathcal{F},\mu}$に埋め込まれ，
